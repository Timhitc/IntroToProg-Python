...
# THitch, 05.15.2022,Added code to complete assignment 5
# ------------------------------------------------------------------------ #
...
tmpTable = [] # Temporary table for removing rows
...
while (True):
    ...
    # Step 4 - Add a new item to the list/Table
        ...
        str_priority = str(input("What is the priority level?"))
    ...
    # Step 5 - Remove a new item from the list/Table
        ...
        for row in lstTable:
            dicRow = row
            if dicRow["Task"].lower() == str_search.lower():
                # lstTable.remove(row) # Don't use Functions
                print("Removed")
            else:
                tmpTable.append(dicRow)
        lstTable = tmpTable
        continue
